"""
Captioning Service - Cache Manager
Redis-based caching with content-based keys (shared pattern with other services)
"""
...
class CacheManager:
    """Manages Redis caching for captioning analysis jobs"""

    def __init__(self, redis_url: str, module: str = "captions", ttl: int = 3600):
        """
    ...
    async def update_job_status(
        ...
        try:
            ...
            if metadata:
                ...
                if gpu_wait_position is not None:
                    metadata['gpu_wait_position'] = gpu_wait_position
